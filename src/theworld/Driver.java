...
public class Driver {
  ...
  public static void main(String[] args) {
    try {
      ...
      BoardGameImpl boardgameimpl = new BoardGameImpl(world.getTargetCharacterImpl(),
          world.getName(), world.getSpaceList(), world.getWorldCoordinates(),
          world.getTargetPetImpl());
      RandomClass demo = new RandomClass();
      new GameConsoleController(input, output, turns, demo).start(boardgameimpl);
    } catch (IOException e) {
